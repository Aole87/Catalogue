...
class PurchaseOrderRepository {
    static async findPurchaseOrders(params = {}, tx = database_1.prisma) {
    ...
    static async findByPoNumber(poNumber, tx = database_1.prisma) {
        return tx.purchaseOrder.findUnique({
    ...
    static async generatePoNumber(tx = database_1.prisma) {
        const now = new Date();
