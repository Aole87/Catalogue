...
exports.PromptPayProvider = void 0;
...
class PromptPayProvider {
    ...
    async createPayment(params) {
        const providerReference = `PP-${Date.now()}-${crypto_1.default.randomBytes(4).toString('hex').toUpperCase()}`;
    ...
    async refundPayment(params) {
        const refundReference = `REF-${Date.now()}-${crypto_1.default.randomBytes(3).toString('hex').toUpperCase()}`;
        return {
            success: true,
            refundReference,
...
exports.PromptPayProvider = PromptPayProvider;
//# sourceMappingURL=promptpay.provider.js.map