...
docker run -d \
  ...
  -e PORT=3000 \
  -e HOST=0.0.0.0 \
  -e DATABASE_URL="${DATABASE_URL:-postgresql://autoparts_user:autoparts_secure_pass123@127.0.0.1:5432/car_parts_catalog?schema=public&connection_limit=25&pool_timeout=20&connect_timeout=10}" \
